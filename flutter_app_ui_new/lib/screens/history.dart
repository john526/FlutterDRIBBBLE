...
class HistoryAppUiPage extends StatefulWidget {
  HistoryAppUiPage():super();
  @override
  _HistoryAppUiPageState createState() => _HistoryAppUiPageState();
}

class _HistoryAppUiPageState extends State<HistoryAppUiPage> {
  @override
